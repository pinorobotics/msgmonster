 ...
 * 
 * Generated for ROS file: test_msgs/Trigger
 */
...
/**
 * Definition for test_msgs/srv/Trigger
 */
public class TriggerServiceDefinition
        implements ServiceDefinition<TriggerRequestMessage, TriggerResponseMessage> {
    private static final MessageDescriptor<TriggerRequestMessage> REQUEST_MESSAGE_DESCRIPTOR =
            new MessageDescriptor<>(TriggerRequestMessage.class);
    private static final MessageDescriptor<TriggerResponseMessage> RESPONSE_MESSAGE_DESCRIPTOR =
            new MessageDescriptor<>(TriggerResponseMessage.class);
